...
# -*- coding: utf-8 -*-
#
# diva documentation build configuration file, created by
...
import os
import sys
sys.path.insert(0, os.path.abspath('../diva'))
...
latex_documents = [
    (master_doc, 'diva.tex', 'diva Documentation',
     'Matthew Riley', 'manual'),
]
...
man_pages = [
    (master_doc, 'diva', 'diva Documentation',
     [author], 1)
]
